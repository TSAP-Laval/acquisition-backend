...
func (a *AcquisitionService) getRouter() http.Handler {
	...
	r.HandleFunc("/api/edition/PostAction", a.PostAction)
	r.HandleFunc("/api/PostJoueur", a.PostJoueur)
	r.HandleFunc("/api/PostTeam", a.PostTeam)
	r.HandleFunc("/api/GetSeasons", a.GetSeasons)
	r.HandleFunc("/api/PostSaison", a.PostSaison)
	r.HandleFunc("/api/getSports", a.GetSports)
	r.HandleFunc("/api/getNiveau", a.GetNiveau)
	r.HandleFunc("/api/getJoueur", a.GetJoueurs)
	r.HandleFunc("/api/getEquipe", a.GetEquipes)
	r.HandleFunc("/api/GetUnNiveau", a.GetUnNiveauTest)
	r.HandleFunc("/api/GetUnNiveau?niveauTest", a.GetUnNiveauTest)
