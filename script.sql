...
DROP TABLE IF EXISTS "actions_types" CASCADE;
...
INSERT INTO actions_Types (id,name,description,id_movement_type) VALUES ('pa','passe','une passe',1);

INSERT INTO movements_type (name) VALUES ('off');